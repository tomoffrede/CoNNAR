...
#f0IQR			- inter-quartile range (upper quartile minus lower quartile) [added by Tom Offrede]
...
soundDir$	= "C:/Users/offredet/Documents/1HU/CoNNAR/CoNNAR/data/all"
#textDir$	= "C:/Users/offredet/Documents/1HU/CoNNAR/data/try"
textDir$ = soundDir$
...
while ifile <= numberOfFiles
	...
	fileappend 'fileForm$' f0min	f0max	f0IQR	intensityMean	intensityMax	
	...
	To Pitch (ac)... 0.0 75 15 no 0.03 0.45 0.01 0.35 0.14 600
   ...
   tierTurns = 18
	...
	select TextGrid 'name$'
		...
		if lab$ == "turn([1-9]|[1-9][0-9]|[1-9][0-9][0-9])"
			...
			f0IQRlower = Get quantile... 'onsetV' 'offsetV' 0.25 Hertz
			f0IQRupper = Get quantile... 'onsetV' 'offsetV' 0.75 Hertz
			f0IQR = f0IQRupper - f0IQRlower
		...
		fileappend 'fileForm$' 'f0min:1'	'f0max:1'	'f0IQR:1'	'intensityMean:1'	'intensityMax:1'	
